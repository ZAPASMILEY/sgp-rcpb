            ...
            <section class="admin-panel ent-window p-6 sm:p-8">
                ...
                <div class="flex items-start gap-4 mt-2">
                    ...
                    <div>
                        ...
                        <h1 class="mt-1 text-2xl font-semibold tracking-tight text-slate-950">Ajouter un secrétaire</h1>
                        <p class="mt-1 text-sm text-slate-500">Secrétaire rattaché à l'Assistante du Directeur Général.</p>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('admin.direction-generale.secretaires.store') }}" class="mt-6 grid gap-5">
                    ...
                    <div class="ent-card space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <input id="email" name="email" type="email" value="{{ old('email') }}" required class="ent-input" placeholder="secretaire@rcpb.bf">
                        </div>
                    ...
                    <div class="rounded-2xl border border-cyan-100 bg-cyan-50 px-4 py-3 text-sm text-cyan-700">
                        ...
                        Un compte de connexion sera généré automatiquement et envoyé par email au secrétaire.
                    </div>
