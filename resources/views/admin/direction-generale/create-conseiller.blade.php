            ...
            <section class="admin-panel ent-window p-6 sm:p-8">
                ...
                <div class="flex items-start gap-4 mt-2">
                    ...
                    <div>
                        ...
                        <h1 class="mt-1 text-2xl font-semibold tracking-tight text-slate-950">Affecter un conseiller du DG</h1>
                        <p class="mt-1 text-sm text-slate-500">Sélectionnez un agent existant avec la fonction <strong>Conseiller DG</strong>.</p>
                    </div>
                </div>
                ...
                @if ($agents->isEmpty())
                    <div class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-700">
                        ...
                        Aucun agent avec la fonction <strong>Conseiller DG</strong> n'est enregistré.
