        ...
        <div class="mx-auto flex max-w-6xl flex-col gap-6">
            ...
            <section class="grid gap-6 md:grid-cols-2 xl:grid-cols-6">
                <article class="admin-panel p-6">
                    ...
                    <p class="mt-3 text-4xl font-bold text-slate-950">{{ $entitesCount }}</p>
                ...
                <article class="admin-panel p-6">
                    ...
                    <p class="mt-3 text-4xl font-bold text-slate-950">{{ $directionsCount }}</p>
                ...
                <article class="admin-panel p-6">
                    ...
                    <p class="mt-3 text-4xl font-bold text-slate-950">{{ $servicesCount }}</p>
                ...
                <article class="admin-panel p-6">
                    ...
                    <p class="mt-3 text-4xl font-bold text-slate-950">{{ $agentsCount }}</p>
                ...
                <article class="admin-panel p-6">
                    ...
                    <p class="mt-3 text-4xl font-bold text-slate-950">{{ $objectifsCount }}</p>
                ...
                <article class="admin-panel p-6">
                    ...
                    <p class="mt-3 text-4xl font-bold text-slate-950">{{ $evaluationsCount }}</p>
