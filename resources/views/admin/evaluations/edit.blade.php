...
@section('title', 'Modifier l\'evaluation #'.$evaluation->id.' | '.config('app.name', 'SGP-RCPB'))
    ...
    <div class="admin-shell min-h-screen px-4 py-6 sm:px-6 lg:px-10">
        <div class="mx-auto flex max-w-4xl flex-col gap-6">
            <header class="admin-panel px-6 py-6 lg:px-8">
                ...
                <p class="mt-2 text-sm text-slate-600">Modification autorisee uniquement en brouillon.</p>
            </header>
                ...
                <form method="POST" action="{{ route('admin.evaluations.update', $evaluation) }}" class="space-y-6">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="evaluable_id" name="evaluable_id" class="ent-select" required data-previous-target="{{ old('evaluable_id', $evaluation->evaluable_id) }}">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <input id="date_debut" name="date_debut" type="date" value="{{ old('date_debut', $evaluation->date_debut->toDateString()) }}" class="ent-input" required>
                        ...
                        <div class="space-y-2">
                            ...
                            <input id="date_fin" name="date_fin" type="date" value="{{ old('date_fin', $evaluation->date_fin->toDateString()) }}" class="ent-input" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="note_manuelle" name="note_manuelle" type="number" min="0" max="100" value="{{ old('note_manuelle', $evaluation->note_manuelle) }}" class="ent-input" placeholder="Optionnel">
                    ...
                    <div class="flex flex-wrap items-center justify-end gap-3">
                        <a href="{{ route('admin.evaluations.show', $evaluation) }}" class="ent-btn ent-btn-soft">Annuler</a>
