            ...
            <div class="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
                ...
                <section class="admin-panel px-6 py-5 lg:px-7">
                    ...
                    <div class="mt-6 rounded-2xl border border-rose-200 bg-rose-50 p-4">
                        ...
                        <form method="POST" action="{{ route('admin.settings.account.destroy') }}" class="mt-3 space-y-3" onsubmit="return confirm('Confirmer la suppression definitive du compte ?');">
                            @csrf
                            @method('DELETE')
