            ...
            <div class="mx-auto flex max-w-4xl flex-col gap-6">
                <header class="admin-panel p-6 sm:p-8">
                    <div class="flex flex-wrap items-start justify-between gap-4">
                        <div>
                            <p class="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500">Faitiere</p>
                            <h1 class="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Faitiere</h1>
                ...
                <section class="grid gap-6 md:grid-cols-4">
                    ...
                    <article class="admin-panel p-6">
                        <p class="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500">Assistante du DG</p>
                        <h2 class="mt-3 text-xl font-semibold text-slate-950">{{ $entite->assistante_dg_prenom }} {{ $entite->assistante_dg_nom }}</h2>
                        <p class="mt-3 text-sm leading-6 text-slate-600">{{ $entite->assistante_dg_email }}</p>
                    </article>
