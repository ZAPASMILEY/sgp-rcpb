...
@php
    ...
    $heroStyle = match ($mode) {
        ...
        default    => 'background: linear-gradient(135deg, #047857, #059669, #0d9488)',
    };
...
<div class="min-h-screen bg-[#f1f5f9] pb-10">
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    <div class="flex items-center gap-2 text-xs font-semibold text-white/60">
                        <a href="{{ route('dg.objectifs.show', $fiche) }}" class="hover:text-white transition">Fiche</a>
    ...
    <div class="px-4 pt-6 lg:px-8">
        ...
        <form method="POST" action="{{ route('dg.objectifs.update', $fiche) }}" class="flex flex-col gap-5">
            @csrf
            @method('PUT')
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-slate-400">Subordonné du DG</p>
                            </div>
                        </div>
                    </div>
