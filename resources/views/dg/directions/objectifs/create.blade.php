            ...
            <section class="admin-panel p-6 sm:p-8">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-600">Créez une fiche et rattachez-la à la direction sélectionnée.</p>
                    </div>
                ...
                <form method="POST" action="{{ route('dg.directions.objectifs.store') }}" class="mt-6 grid gap-5">
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="titre_fiche" name="titre_fiche" value="{{ old('titre_fiche') }}"
                               required class="ent-input"
                               placeholder="Ex : Contrat d'objectifs 2026 — {{ $direction->nom }}">
                    </div>
