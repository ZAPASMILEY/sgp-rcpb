    ...
    <div class="mx-auto max-w-5xl flex flex-col gap-6">
        ...
        <header class="admin-panel px-6 py-6 lg:px-8">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    <p class="text-xs font-bold uppercase tracking-[0.2em] text-slate-400">Espace DG / Délégations</p>
                ...
                <a href="{{ route('dg.delegations') }}" class="ent-btn ent-btn-soft">Retour</a>
            </div>
        </header>
        ...
        <section class="admin-panel overflow-hidden">
            <div class="border-b border-slate-100 px-6 py-4 flex items-center justify-between">
                <h2 class="text-sm font-black uppercase tracking-widest text-slate-700">Caisses <span class="ml-2 rounded-full bg-amber-100 px-2 py-0.5 text-xs font-black text-amber-700">{{ $delegation->caisses->count() }}</span></h2>
            </div>
                    ...
                    @foreach ($delegation->caisses as $caisse)
                        <div class="flex items-center justify-between px-6 py-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <a href="{{ route('dg.caisses.show', $caisse) }}" class="ent-btn ent-btn-soft py-1 px-3 text-xs"><i class="fas fa-eye mr-1"></i>Voir</a>
                            </div>
                        </div>
                    @endforeach
                </div>
