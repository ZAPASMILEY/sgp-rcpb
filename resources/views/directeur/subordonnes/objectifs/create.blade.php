            ...
            <form method="POST" action="{{ route($storeRoute) }}" class="px-6 py-5 grid gap-5">
                ...
                <div class="border-t border-slate-100 pt-4 flex flex-col sm:flex-row gap-3">
                    ...
                    <button type="submit" name="action" value="envoyer"
                            class="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-violet-600 px-6 py-3.5 text-sm font-black text-white shadow-sm transition hover:bg-violet-700">
