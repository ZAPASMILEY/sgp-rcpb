                ...
                <form method="POST" action="{{ route('directeur.subordonnes.secretaire.evaluations.store') }}" class="space-y-8">
                    ...
                    <section class="space-y-6">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-500">Vérifiez les informations et renseignez la période concernée.</p>
                        </div>
                        ...
                        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <input id="identification_emploi" name="identification[emploi]" type="text"
                                       value="{{ old('identification.emploi', 'Secrétaire') }}" class="ent-input">
                            </div>
                            <div class="space-y-2">
                                ...
                                <input id="identification_nom_prenom" name="identification[nom_prenom]" type="text"
                                       value="{{ old('identification.nom_prenom', $secretaire->name) }}" class="ent-input">
                            </div>
                            <div class="space-y-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <input id="identification_direction_service" name="identification[direction_service]" type="text"
                                       value="{{ old('identification.direction_service', 'Secrétariat') }}" class="ent-input">
                            </div>
                        </div>
                    ...
                    <section class="space-y-5 border-t border-slate-200 pt-8">
                        ...
                        <div class="grid gap-5 md:grid-cols-2">
                            <div class="space-y-2">
                                <label for="signature_evalue_nom" class="text-xs font-semibold uppercase tracking-[0.15em] text-slate-500">Évalué(e) — Secrétaire</label>
                                <input id="signature_evalue_nom" name="signature_evalue_nom" type="text"
                                       value="{{ old('signature_evalue_nom', $secretaire->name) }}" class="ent-input">
