        ...
        <div class="mt-5 grid gap-4 lg:grid-cols-3">
            ...
            <div class="rounded-[24px] border border-emerald-100 bg-white p-5 shadow-sm">
                ...
                <div class="mt-4 flex gap-2">
                    ...
                    @else
                        <span title="Fonctionnalité désactivée par l'administrateur"
                              class="inline-flex cursor-not-allowed items-center gap-2 rounded-xl bg-slate-300 px-3 py-2 text-xs font-black text-slate-500 opacity-60 select-none">
                            <i class="fas fa-plus text-[10px]"></i> Évaluer
                        </span>
                    @endif
                            ...
                            <div class="flex items-center gap-3 shrink-0">
                                ...
                                @else
                                    <span title="Fonctionnalité désactivée"
                                          class="inline-flex h-7 w-7 cursor-not-allowed items-center justify-center rounded-lg bg-slate-50 text-slate-300 opacity-60 select-none">
                                        <i class="fas fa-pen text-[10px]"></i>
                                    </span>
                                @endif
                            </div>
