    ...
    <div class="w-full max-w-lg">
        <div class="rounded-[32px] bg-white p-10 shadow-xl text-center">
            ...
            <p class="mt-4 text-sm text-slate-500 leading-relaxed">
                Votre compte <strong>Directeur</strong> est bien créé, mais il n'est pas encore associé à une
                structure (direction, caisse ou délégation technique).
                <br><br>
                L'administrateur doit compléter la configuration en éditant la structure concernée et en vous
                désignant comme directeur responsable.
            </p>
            ...
            <div class="mt-8 rounded-2xl border border-amber-100 bg-amber-50 px-5 py-4 text-left">
                ...
                <ol class="mt-3 space-y-2 text-sm text-amber-800">
                    <li class="flex items-start gap-2">
                        ...
                        Aller dans <strong>Administration → Structures</strong> (Directions, Caisses ou Délégations)
                    </li>
                    <li class="flex items-start gap-2">
                    ...
                    <li class="flex items-start gap-2">
                        ...
                        Sélectionner cet agent dans le champ <strong>Directeur responsable</strong>
                    </li>
                </ol>
            </div>

            <form method="POST" action="{{ route('directeur.pending.logout') }}" class="mt-8">
                @csrf
                <button type="submit"
