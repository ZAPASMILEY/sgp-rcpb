            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    <p class="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500">
                        Espace Directeur / {{ $isReceived ? 'Mes évaluations' : 'Ma direction' }}
                    </p>
                ...
                <div class="flex shrink-0 flex-wrap items-center gap-2">
                    <a href="{{ route('directeur.evaluations.pdf', $evaluation) }}" class="ent-btn ent-btn-soft">
                        <i class="fas fa-file-pdf mr-2"></i>Télécharger PDF
                    </a>
                    <a href="{{ route('directeur.mon-espace') }}" class="ent-btn ent-btn-soft">Retour</a>
                </div>
            </div>
        </header>
        ...
        <section class="admin-panel px-6 py-6 lg:px-8">
            <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    {{-- Boutons pour évaluation reçue : Accepter / Refuser --}}
                    ...
                    @if ($isCreated && $evaluation->statut === 'brouillon')
                        <form method="POST" action="{{ route('directeur.evaluations.submit', $evaluation) }}"
                              onsubmit="return confirm('Soumettre cette évaluation au chef de service ?')">
                            @csrf
                            @method('PATCH')
                            <button type="submit" class="ent-btn ent-btn-primary">
