...
<div class="min-h-screen bg-[#f1f5f9] pb-12">
    ...
    <div class="relative overflow-hidden px-6 py-8 lg:px-10"
        ...
        <div class="pointer-events-none absolute -bottom-10 left-1/3 h-48 w-48 rounded-full bg-emerald-300/10 blur-2xl"></div>
        <div class="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-xs font-black uppercase tracking-[0.2em] text-emerald-200">Mon Espace · RCPB</p>
                    <h1 class="mt-0.5 text-2xl font-black text-white">Statistiques du personnel</h1>
                    <p class="mt-0.5 text-sm text-emerald-100/75">Notes semestrielles et annuelles — tout le réseau</p>
                </div>
            </div>
