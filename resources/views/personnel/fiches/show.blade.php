    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-slate-700 via-slate-600 to-slate-500 px-6 py-8 lg:px-10">
        ...
        <div class="relative flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div class="flex shrink-0 flex-wrap items-center gap-2">
                ...
                <a href="{{ route('personnel.dashboard') }}?tab=objectifs"
    ...
    <div class="px-4 pt-6 lg:px-8">
        ...
        <div class="flex flex-col gap-4 rounded-[24px] border-2 border-amber-200 bg-amber-50 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap gap-3">
                <form action="{{ route('personnel.fiches.statut', $fiche) }}" method="POST">
                    @csrf @method('PATCH')
        ...
        <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <div class="rounded-[20px] border border-slate-100 bg-white px-5 py-4 shadow-sm">
                ...
                {{-- Sélecteur d'avancement uniquement sur les fiches acceptées --}}
                @if ($fiche->statut === 'acceptee')
                    <form method="POST" action="{{ route('personnel.fiches.avancement', $fiche) }}" class="mt-2">
                        @csrf @method('PATCH')
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 rounded-[24px] bg-white px-6 py-4 shadow-sm ring-1 ring-slate-100">
            ...
            <a href="{{ route('personnel.fiches.pdf', $fiche) }}"
