        ...
        <div class="mx-auto flex max-w-6xl flex-col gap-6">
            ...
            <section class="admin-panel px-6 py-6 lg:px-8">
                ...
                <div class="mt-6 border-t border-slate-200 pt-6">
                    ...
                    @endphp
                    <span class="mt-2 inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold {{ $statusClass }}">
                ...
                <div class="mt-6 flex flex-wrap items-center justify-end gap-3 border-t border-slate-200 pt-6">
                    ...
                    @if ($evaluation->statut === 'soumis')
                        <form method="POST" action="{{ route('pca.evaluations.approve', $evaluation) }}">
                            @csrf
