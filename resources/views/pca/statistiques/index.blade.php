            ...
            <header class="admin-panel px-6 py-6 lg:px-8">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-600">Suivi des objectifs et evaluations de l'entite et des directeurs pour {{ $selectedYear }}.</p>
                    </div>
                    <form method="GET" action="{{ route('pca.statistiques.index') }}" class="grid gap-2 sm:grid-cols-[minmax(0,180px)_auto] sm:items-end">
                        <div>
