            ...
            <section class="admin-panel p-6 sm:p-8">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-600">Assignez un objectif a votre entite ou a l'un de ses directeurs.</p>
                    </div>
                    ...
                    <div class="ent-form-grid">
                        <div class="space-y-2">
                            ...
                            <select id="assignable_type" name="assignable_type" required class="ent-select">
                                ...
                                <option value="direction" @selected(old('assignable_type') === 'direction')>Directeur (Direction)</option>
                            </select>
                        </div>
                        <div class="space-y-2">
