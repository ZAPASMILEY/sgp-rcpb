{{-- Dossier complet avec onglets : Objectifs | Evaluations (DGA) --}}
{{-- Variables attendues : $tab, $fiches, $fichesStats, $evaluations, $evaluationsStats, $filters, $currentSubordonneId --}}
...
@else
    <div class="admin-panel px-6 py-6">
        ...
        @if ($tab === 'objectifs')
            @include('dga.subordonnes._tab_objectifs')
        @else
            @include('dga.subordonnes._tab_evaluations')
        @endif
    </div>
@endif
