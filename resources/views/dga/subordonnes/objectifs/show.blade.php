...
@php
    ...
    $backUrl       = route('dga.subordonnes.show', $subordonne).'?tab=objectifs';
@endphp
        ...
        <div class="relative flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
                <div class="flex items-center gap-2 text-xs font-semibold text-indigo-300">
                    <a href="{{ $backUrl }}" class="hover:text-white transition">Dossier subordonné</a>
                ...
                <p class="mt-1 text-sm text-indigo-100/80">Assignée à <span class="font-semibold text-white">{{ $subordonne?->name ?? '—' }}</span></p>
            </div>
