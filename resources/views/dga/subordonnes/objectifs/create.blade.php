            ...
            <div class="overflow-hidden rounded-[24px] bg-white shadow-sm ring-1 ring-slate-100">
                ...
                <form method="POST" action="{{ route('dga.sub-objectifs.store') }}" class="px-6 py-5 grid gap-5">
                    ...
                    <div class="border-t border-slate-100 pt-4">
                        <button type="submit"
                                class="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-6 py-3.5 text-sm font-black text-white shadow-sm transition hover:bg-indigo-700">
