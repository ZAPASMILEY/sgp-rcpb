...
<div class="min-h-screen bg-[#f1f5f9] pb-12">
    ...
    <div class="relative overflow-hidden px-6 py-8 lg:px-10"
         style="background:linear-gradient(135deg,#155e75 0%,#0e7490 50%,#0891b2 100%)">
        ...
        <div class="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-xs font-black uppercase tracking-[0.2em] text-cyan-200">Ressources Humaines · RCPB</p>
