...
<div class="min-h-screen bg-[#f1f5f9] pb-12">
    ...
    <div class="relative overflow-hidden px-6 py-8 lg:px-10"
        ...
        <div class="relative flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-black uppercase tracking-[0.2em] text-blue-200">Ressources Humaines · RCPB</p>
                <h1 class="mt-0.5 text-2xl font-black text-white">Tableaux personnalisés</h1>
                <p class="mt-0.5 text-sm text-blue-100/75">Configurez et exportez vos propres rapports Excel</p>
            </div>
        </div>
    </div>
